...
fun AlbumInfoPanel(
    ...
    val firstTrackInAlbum = trackState.currentList[0]
        ...
        val summaryDuration = trackState.currentList.sumOf { it.duration }
        ...
        LocalizationProvider.strings.apply {
            ...
            val map = mapOf(
                ...
                infoDialogAlbumId to trackState.currentList[0].albumId.toString(),
                                            ...
                                            TrackUiEvent.upsertTrack(
                                                track.copy(
                                                    ...
                                                    onEvent(TrackUiEvent.updateTrackState(
                                                        trackState.copy(
                                                                currentList = trackState.currentList
